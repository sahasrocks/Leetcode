...
<pre style="position: relative;"><strong>Input:</strong> n = 10, k = 1, maxPts = 10
...
<pre style="position: relative;"><strong>Input:</strong> n = 6, k = 1, maxPts = 10
...
<pre style="position: relative;"><strong>Input:</strong> n = 21, k = 17, maxPts = 10
