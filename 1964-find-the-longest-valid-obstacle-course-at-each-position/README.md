...
<pre style="position: relative;"><strong>Input:</strong> obstacles = [1,2,3,2]
...
<pre style="position: relative;"><strong>Input:</strong> obstacles = [2,2,1]
...
<pre style="position: relative;"><strong>Input:</strong> obstacles = [3,1,5,6,4,2]
